...
# -*- coding: utf-8 -*-
"""
FinalizeCampaign_TRACKER_STRICT_v3_MAILZIP.py

Same behavior as your v3 strict finalizer, BUT ZIP resolution now
prioritizes the *mailing/owner ZIP*. Wherever we infer or backfill ZIP5,
we check MAIL/OWNER fields and mailing-address strings before property/situs.
"""
...
# ------------- Core -------------
def main():
    ap = argparse.ArgumentParser(description="Finalize a campaign: append executed log (idempotent), update master tracker, rebuild mailing-ZIP tally.")
